...
echo "[1/7] Adding Surface Linux repository..."
...
echo ""
echo "[3/7] Installing Surface kernel packages..."
...
echo ""
echo "[4/7] Detecting installed Surface kernel..."
...
echo ""
echo "[5/7] Copying kernel files to ESP partition..."
...
echo ""
echo "[6/7] Creating systemd-boot entry..."
